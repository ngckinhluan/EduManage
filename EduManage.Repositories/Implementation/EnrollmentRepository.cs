...
namespace EduManage.Repositories.Implementation
{
    public class EnrollmentRepository(EnrollmentDao enrollmentDao) : IEnrollmentRepository
    {
        ...
        {
            return enrollmentDao.GetEnrollmentById(studentId, courseId);
        }

        public void Add(Enrollment entity)
        {
            enrollmentDao.AddEnrollment(entity);
        }

        public void Update(int studentId, int courseId, Enrollment entity)
        {
            enrollmentDao.UpdateEnrollment(studentId, courseId, entity);
        }
